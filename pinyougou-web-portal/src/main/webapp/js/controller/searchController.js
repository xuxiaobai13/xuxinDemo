app.controller('searchController',function($scope,$location,searchService){
    ...
    // $scope.searchMap={'sortField':'price或updatetime'};
    ...
    //定义搜索对象的结构  category:商品分类
   // $scope.searchMap={'keywords':'千度','category':'','brand':'','spec':{},'price':'','pageNo':1,'pageSize':40,'sort':'','sortField':''};
	...
	$scope.openDetailPage = function(goodsId){
		//alert(goodsId);  http://localhost:9101/149187842867976.html
